...
base_dir = Path(covid_model_deaths.__file__).parent
...
# since we have a lot of tables in the documentation, lets make them wider
# by default and with wrapped text

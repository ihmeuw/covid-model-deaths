...
def try_location_specific_death_threshold_rate(location_id, df, ln_death_rate_threshold, collapse_neg=False):
    try:
        return location_specific_death_threshold_date(df, location_id, ln_death_rate_threshold, collapse_neg)
    except Exception:
